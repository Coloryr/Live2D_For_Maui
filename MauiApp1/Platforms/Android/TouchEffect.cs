...
namespace MauiApp1.Platforms.Android
{
    public class TouchEffect : PlatformEffect
    {
        ...
        MauiApp1.TouchEffect libTouchEffect;
        bool capture;
        Func<double, double> fromPixels;
        int[] twoIntArray = new int[2];

        static Dictionary<View, TouchEffect> viewDictionary =
        ...
        protected override void OnAttached()
        {
            ...
            MauiApp1.TouchEffect touchEffect =
                (MauiApp1.TouchEffect)Element.Effects.
                    FirstOrDefault(e => e is MauiApp1.TouchEffect);
